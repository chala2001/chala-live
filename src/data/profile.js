...
export const about = {
  paragraphs: [
    "I'm a Computer Engineering undergraduate at the University of Peradeniya. Writing the service is only the start of it for me; I want to containerise it, stand up the infrastructure it runs on, and keep it healthy once real people depend on it.",
...
export const projects = [
  ...
  },
  {
    ...
    featured: true,
    description:
      'CloudCare taken a step further. The same hospital system, moved off a monolithic EC2/ASG deployment and onto a microservices architecture orchestrated on Kubernetes, the way engineering teams actually run production workloads.',
  ...
  },
  {
    ...
    featured: false,
    description:
      'A full local Kubernetes setup: 4 FastAPI microservices orchestrated via Helm, NGINX Ingress, HPA auto-scaling, and a Prometheus / Grafana / Loki observability stack on top.',
  ...
  },
  {
    ...
    featured: false,
    description:
      'Kubernetes orchestration for the LMS platform, a full migration off Docker Compose onto a scalable, self-healing K8s cluster with automated load balancing and persistent storage.',
